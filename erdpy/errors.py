...
class KnownError(Exception):
    ...
    def __init__(self, message: str, inner: Union[Any, None] = None) -> None:
...
class BadFile(KnownError):
    def __init__(self, filename: str, inner: Union[Any, None] = None) -> None:
...
class PlatformNotSupported(KnownError):
    def __init__(self, action_or_item: str, platform: str) -> None:
...
class BadInputError(KnownError):
    def __init__(self, input: str, message: str) -> None:
...
class ExternalProcessError(KnownError):
    def __init__(self, command_line: str, message: str) -> None:
