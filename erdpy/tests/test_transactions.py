...
class TransactionsTestCase(MyTestCase):
    ...
    def test_serialize_transaction_payload(self) -> None:
        # With data field
    ...
    def test_serialize_transaction_with_usernames(self) -> None:
        transaction = Transaction()
    ...
    def test_serialize_transaction_as_inner(self) -> None:
        transaction = Transaction()
        transaction.nonce = 0
        transaction.value = "0"
        transaction.sender = "erd1l453hd0gt5gzdp7czpuall8ggt2dcv5zwmfdf3sd3lguxseux2fsmsgldz"
